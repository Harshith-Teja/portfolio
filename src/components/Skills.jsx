  ...
  return (
    <article className='flex flex-col gap-8 max-w-[80%] m-auto mt-12 text-zinc-900 dark:text-cyan-50'>
        ...
        <div className='grid grid-cols-2 place-items-center place-content-center md:grid-cols-3 gap-8'>
           ...
           <img src="../../skills Logos/JavaScript-Logo.png" alt="Javascript Logo" className='h-32 w-26 border-zinc-600 hover:scale-110 transition-all duration-200 ease-in'/>
           ...
           <img src="../../skills Logos/Expressjs-Logo.png" alt="ExpressJs Logo" className='h-36 w-36  hover:scale-110 transition-all duration-200 ease-in'/>
